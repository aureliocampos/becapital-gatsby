        ...
        <div className="banner__content">
          <div className="banner__primary-description">
            ...
            <div className="button__container">
              <a href="https://api.whatsapp.com/send?phone=5521965431886" target="_blank" rel="noopener noreferrer" className="button button__secondary">Simule seu investimento</a>
            </div>
          </div>
        </div>
      </section>

...
const ServicesPostTemplate = ({
  ...
  const bannerImage = (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_7__.getImage)(service.featuredImage.node.localFile);
  const bodyImage = (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_7__.getImage)(service.pageFieldsServices.subBanner.imagem.localFile);
